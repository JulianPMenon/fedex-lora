...
# Fedaverage with Vera
# python fed_train_glue.py --model=models/models--FacebookAI--roberta-base/snapshots/e2da8e2f811d1448a5b465c236feacd80ffbac7b --task=cola --agg_type=ffa --vera --num_clients=3 --r=120 --rounds=3 --lr=1e-3 --local_epochs=80
# Run your FedEXLora script for this client
python fed_train_glue.py --model=models/models--FacebookAI--roberta-base/snapshots/e2da8e2f811d1448a5b465c236feacd80ffbac7b --task=mrpc --agg_type=ours --num_clients=3 --r=6 --rounds=3 --lr=1e-3 --local_epochs=80  
